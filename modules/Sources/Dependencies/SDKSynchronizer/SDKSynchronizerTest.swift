...
extension SDKSynchronizerClient: TestDependencyKey {
    public static let testValue = Self(
        ...
        createTransactionFromPCZTWithoutSubmitting: unimplemented("\(Self.self).createTransactionFromPCZTWithoutSubmitting", placeholder: []),
...
extension SDKSynchronizerClient {
    public static let noOp = Self(
        ...
        createTransactionFromPCZTWithoutSubmitting: { _, _ in [] },
...
extension SDKSynchronizerClient {
    public static func mocked(
        ...
        createTransactionFromPCZTWithoutSubmitting: @escaping (Pczt, Pczt) async throws -> [ZcashTransaction.Overview] = { _, _ in [] },
        ...
        SDKSynchronizerClient(
            ...
            createTransactionFromPCZTWithoutSubmitting: createTransactionFromPCZTWithoutSubmitting,
